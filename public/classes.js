...
class xothndzox {
    ...
    bazmanal() {
        ...
        if (vand && this.energy >= this.speed) {
            this.energy = 1;
            var newxothndzox = new xothndzox(vand[0], vand[1], 2);
            xothndzoxArr.push(newxothndzox);
        }
    }
    ...
    mahanal() {
        if (this.energy <= -(this.speed / 2)) {
            matrix[this.y][this.x] = 0;
            for (var i in xothndzoxArr) {
                if (xothndzoxArr[i].x == this.x && xothndzoxArr[i].y == this.y) {
                    xothndzoxArr.splice(i, 1);
                }
            }
        }
    }
